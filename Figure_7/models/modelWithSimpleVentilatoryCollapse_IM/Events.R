dosingevents <- function(
  ...
  if (naloxone_doseN == 1) {
    ...
    eventdata <- rbind(
      ...
      data.frame(
        var = "D",
        time = c(naloxone_time, naloxone_time + gap),
        value = c(naloxone_dose, naloxone_dose),
        method = "add"
      )
    )
    ...
    eventdata <- rbind(
      ...
      data.frame(
        var = "D",
        time = c(naloxone_time, naloxone_time + gap, naloxone_time + gap + gap),
        value = c(rep(naloxone_dose, 2), naloxone_dose),
        method = "add"
      )
    )
    ...
    eventdata <- rbind(
      ...
      data.frame(
        ...
        time = c(
          naloxone_time,
          naloxone_time + gap,
          naloxone_time + gap + gap,
          naloxone_time + gap + gap + gap
        ),
        value = c(rep(naloxone_dose, 2), rep(naloxone_dose, 2)),
        method = "add"
      )
    )
    ...
    eventdata <- rbind(
      ...
      data.frame(
        var = "D",
        time = c(naloxone_time),
        value = c(2 * naloxone_dose),
        method = "add"
      )
    )
    ...
    eventdata <- rbind(
      ...
      data.frame(
        var = "D",
        time = c(naloxone_time, naloxone_time + gap),
        value = c(2 * naloxone_dose, 2 * naloxone_dose),
        method = "add"
      )
    )
  }
